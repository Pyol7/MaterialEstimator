...
//
///**
// * Displays the dialog for adding a BaseMaterial.
// */
...
//        void onAddMaterialDialogSubmit(BaseMaterial material);
//    }
//
//    /**
...
//        dialogBuilder.setTitle("Add BaseMaterial");
...
//        ProjectItemsSharedPreferences appSPHelper = new ProjectItemsSharedPreferences(
//                getString(R.string.default_material_lists),
//                context
//        );
//        MaterialList spinnerList = appSPHelper
//                .get(context.getString(R.string.default_material_list_key));
...
//        ArrayAdapter<BaseMaterial> adapter = new ArrayAdapter<>(
//                context,
...
//                        (BaseMaterial) parent.getItemAtPosition(position);
//
//                setDataToViews(dialogView, selectedMaterial);
//            }
//            @Override
